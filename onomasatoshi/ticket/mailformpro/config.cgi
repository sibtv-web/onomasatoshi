...
この度は Masatoshi Ono Christmas Live へお申し込み頂き、誠にありがとうございました。
お申し込み内容は下記の通りです。
...
整理番号は抽選となっております。
整理番号は当日チケット引換時にご確認下さいませ。

■チケット引き換えについて

チケット引き換えは開場時間の60分前より会場入り口付近、受付にて行います。
ご予約名とチケット枚数をご申告頂き、チケットをお引き換え下さい。
受付番号の確認をさせて頂く場合がございますので、お手元にご準備下さいませ。

・お支払い金額＝（チケット料金×枚数）　※入場時ドリンク代別途

開場時間の10分前より入場整列を開始致します。
開場時その場にいらっしゃらないお客様、チケット引き換えがお済みでないお客様に関しましては、
整理番号通りにご入場頂けない場合がございますのであらかじめご了承下さい。
スムーズなご入場、チケット引き換えのご協力をお願い致します。
