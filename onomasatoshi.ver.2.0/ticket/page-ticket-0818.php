<?php
/*
Template Name: page-ticket-0818
*/
	get_header();
?>
<article>
		<section id="sec-ticket">
			...
			<h2 class="page-title">【ファンクラブ限定発売】FC限定ライブ 360°ステージ チケット</h2>
			<div id="ticket-content">
				<div class="ticket-contents-li">
					<h3 class="title">【ファンクラブ限定発売】小野正利 FC限定ライブ 360°ステージチケットフォーム<br><span class="term">（ 受付期間：7/23（月）12:00～7/27（金）12:00 ）</span></h3>
					<div class="ticket-explain">
						<dl>
							<dt>[ 公演タイトル ] </dt>
							<dd>小野正利 FC限定ライブ 360°ステージ</dd>
							<dt>[ 公演日 ] </dt>
							<dd>2018/8/18（土）</dd>
							<dt>[ OPEN/START ] </dt>
							<dd>1部14:30/15:00</dd>
							<dd>2部17:30/18:00</dd>
							<dt>[ 会場 ] </dt>
							<dd><a href="http://www.sactsow.com/Contact.html" target="_blank">新宿 SACT!</a></dd>
							<dt>[ 住所 ]</dt>
							<dd>160-0022　新宿区新宿6丁目28-8ラ・ベルティ新宿B1</dd>
						</dl>
					</div>
				</div>
			...
			<div class="ticket-contents-li">
				<div id="content-text">
					...
					<ul class="ticket-explain">
						...
						<li class="text-block">
							■重複申し込みについて<br>
							当公演はお一人様につき1部、2部どちらか1公演のみ閲覧可能です。<br>
							システム上、予約申し込みは何度でもできますが、同名、または同メールアドレスの方からのお申し込みがあった場合は、
							もっとも新しい（もっとも後の）予約申し込みのみを受付させていただきます。<br>
							また、チケットの整理番号は抽選のため、お申し込み時期の早さは整理番号とは関係ございません。
						</li>
					</ul>
				</div>
				</div>
			<div id="contact-content">
				...
				<form id="mailformpro" action="<?php echo get_template_directory_uri(); ?>/ticket/mailformpro/mailformpro.cgi" method="POST">
					<input type="hidden" name="公演タイトル" value="小野正利 FC限定ライブ 360°ステージ">
					<input type="hidden" name="公演日" value="2018/8/18（土）">

					<div class="mfp_phase" summary="注文内容">
						<dl class="mailform">
						<dt class="mfp"><span class="must">必須</span>公演時間の選択</dt>
						<dd>
								<label><input type="radio" name="公演時間" value="1部 14:30/15:00 [OPEN/START]"> 1部 14:30/15:00</label><br>
								<label><input type="radio" name="公演時間" value="2部 17:30/18:00 [OPEN/START]"> 2部 17:30/18:00</label><br>
								<label><input type="radio" name="公演時間" value="どちらでも良い"> どちらでも良い</label>
						</dd>
						</dl>

						<input type="hidden" name="会場" value="新宿 SACT!">
						<input type="hidden" name="住所" value="〒160-0022　新宿区新宿6丁目28-8ラ・ベルティ新宿B1">

						<dl class="mailform" id="ticket_wrap">
							<dt class="mfp"><span class="must">必須</span>お申込み枚数</dt>
							<dd class="mfp">
								<ol>
									<input type="hidden" name="お申込み枚数" data-join="小野正利 FC限定ライブ 360°ステージ+ +枚" value="" />
									<li>
										小野正利 FC限定ライブ 360°ステージ　3,000円
										<select data-price="3000" name="小野正利 FC限定ライブ 360°ステージ" required="required" >
