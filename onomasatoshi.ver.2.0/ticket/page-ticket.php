...
<article>
		<section id="sec-ticket">
			...
			<h2 class="page-title">【ファンクラブ先行】小野正利ライブ チケットフォーム</h2>
			<div id="ticket-content">
				<div class="ticket-contents-li">
					<h3 class="title">【ファンクラブ先行】チケット情報　<span class="term">（ 受付期間：6/18（月）12:00～6/25（月）12:00 ）</span></h3>
					<div class="ticket-explain">
						<dl>
							<dt>[ 公演タイトル ] </dt>
							<dd>小野正利ソロライブ「大場の夕日」</dd>
							<dt>[ 公演日 ] </dt>
							<dd>2018/7/28（土）</dd>
							<dt>[ OPEN/START ] </dt>
							<dd>18:30/19:00</dd>
							<dt>[ 会場 ] </dt>
							<dd><a href="http://1091m.com/?page_id=55" target="_blank">aube shibuya</a></dd>
							<dt>[ 住所 ]</dt>
							<dd>〒150-0042 東京都渋谷区宇田川町4−７ トウセン宇田川町ビル5F</dd>
						</dl>
					</div>
				</div>
			...
			<div id="contact-content">
				...
				<form id="mailformpro" action="<?php echo get_template_directory_uri(); ?>/ticket/mailformpro/mailformpro.cgi" method="POST">
					<input type="hidden" name="公演タイトル" value="小野正利ソロライブ「大場の夕日」">
					<input type="hidden" name="公演日" value="2018/7/28（土）open/start 18:30/19:00">
					<!-- <input type="hidden" name="OPEN/START" value="18:30/19:00"> -->
					<input type="hidden" name="会場" value="aube shibuya">
					<input type="hidden" name="住所" value="〒150-0042 東京都渋谷区宇田川町4−７ トウセン宇田川町ビル5F">
					...
					<div class="mfp_phase" summary="注文内容">
						<dl class="mailform" id="ticket_wrap">
							...
							<dd class="mfp">
								<ol>
									<input type="hidden" name="チケット枚数" data-join="小野正利ソロライブ「大場の夕日」+ +枚" value="" />
									<li>
										小野正利ソロライブ「大場の夕日」　4,000円
										<select data-price="4000" name="小野正利ソロライブ「大場の夕日」" required="required" >
