...
## フォームの送信先
push @mailto,'eandm@sib.tv';
push @mailto,'yoshikawa@sib.tv';
push @mailto,'k-murakami@sib.tv';

## 自動返信メールの差出人名
$config{'fromname'} = '［小野正利公式サイト］お問い合わせ';
...
$config{'ThanksPage'} = 'http://onomasatoshi.com/thanks/';

## 設置者に届くメールの件名
$config{'subject'} = '［小野正利公式サイト］お問い合わせ';

## 設置者に届くメールの本文整形
$_TEXT{'posted'} = <<'__posted_body__';
<_mfp_date_>
［小野正利公式サイト］お問い合わせフォームより以下のメールを受付ました。
──────────────────────────
受付番号：<_mfp_serial_>
...
$config{"ReturnSubject"} = '［小野正利公式サイト］お問い合せありがとうございました';
