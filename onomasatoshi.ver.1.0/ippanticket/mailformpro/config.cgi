...
$config{'ThanksPage'} = 'https://www.onomasatoshi.com/ippanticket-thanks/';
...
$config{"ReturnSubject"} = '［小野正利ライブ］チケットお申込みありがとうございました';
...
この度は『小野正利デビュー日記念イベント　K.O.E Ⅱ』へお申し込み頂き、誠にありがとうございました。
お申し込み内容は下記の通りです。
...
■チケット引き換えについて
チケット引き換えは開演1時間前より会場入り口付近、受付にて行います。
ご予約名とチケット枚数をご申告頂き、チケットをお引き換え下さい。
（チケット料金×枚数）
※お申込番号の確認をさせて頂く場合がございますので、お手元にご準備下さいませ。

チケット引き換え後は開場時間までにお戻り頂き、再度ご整列頂きます。
開場時その場にいらっしゃらないお客様に関しては整理番号通りご入場頂けない場合がございますのであらかじめご了承下さい。

チケットの整理番号は開示致しておりません。チケットの引き換えをもって整理番号をご確認下さい。

※ワンドリンク別途。
※受付にてご予約代表者名をご申告頂き、代金をお支払い下さい。
※当日は整理番号順入場となります。（整理番号は抽選となります。）
※原則として未就学児童入場不可
※入場順は【ファンクラブ先行】→【一般発売】となります。
...
　株式会社シブヤテレビジョン
　マネジメント事業部
　〒150-0041 東京都渋谷区神南1-15-3
　TEL / 03-3770-4288　FAX / 03-3770-4290
　http://www.sib.tv/
━━━━━━━━━━━━━━━━━━━━━━━━━━
